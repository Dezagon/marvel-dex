...
import type { LoginFormType, Token } from "../typescripts/types";
...
export const Login: React.FC<LoginProps> = ({ setUserLoggedIn, userLoggedIn }) => {
  ...
  const formDataToObjectLogin = (loginFormData: FormData): LoginFormType => {
    const query: LoginFormType = {
  ...
  const loginUser = async (formData: FormData) => {
    const data: LoginFormType = formDataToObjectLogin(formData);
    console.log(data);
    try {
